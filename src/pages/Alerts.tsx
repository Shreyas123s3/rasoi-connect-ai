                    ...
                    <CardHeader>
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <Badge 
                            className={alert.isActive ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}
                          >
                    ...
                    <CardContent>
                      <div className="grid md:grid-cols-3 gap-4 mb-4">
                        <div className="text-center">
                          <div className="text-2xl font-black text-red-600">₹{alert.currentPrice}</div>
                          <div className="text-sm font-semibold text-gray-500">Current Price</div>
                        </div>
                        <div className="text-center">
                          <div className="text-2xl font-black text-[#59D35D]">₹{alert.priceThreshold}</div>
                          <div className="text-sm font-semibold text-gray-500">Alert Price</div>
                        </div>
                        <div className="text-center">
                          <div className="flex items-center justify-center">
                            {alert.currentPrice <= (alert.priceThreshold || 0) ? (
                      ...
                      <div className="flex items-center text-sm text-gray-600">
                        ...
                        <span className="font-semibold">Created {alert.timestamp.toLocaleDateString()}</span>
                      </div>
                    </CardContent>
                  </Card>
                ))
