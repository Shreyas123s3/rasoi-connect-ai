...
const BulkOrders = () => {
  const { bulkOrders, loading, joinBulkOrder, refetch } = useBulkOrders();
  const { user } = useAuth();
              ...
              <>
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-center">
                    <h2 className="text-3xl font-black text-black">Live Bulk Orders</h2>
                    <Button 
                  ...
                  {filteredOrders.length === 0 ? (
                    <Card className="bg-white/95 border-2 border-white/30 backdrop-blur-sm">
                      <CardContent className="p-12 text-center">
                        ...
                        <p className="text-gray-500 mb-4">Be the first to start a bulk order in this category!</p>
                        <Button 
                          onClick={() => setShowCreateForm(true)}
                          className="bg-[#59D35D] hover:bg-[#4BC44F] text-black font-bold"
                        >
