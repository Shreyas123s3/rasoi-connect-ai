...
const BulkOrders = () => {
  const { user } = useAuth();
  const { bulkOrders, loading, error, joinBulkOrder, participationStatus, refetch } = useBulkOrders();
        ...
        <div className="max-w-6xl mx-auto p-6">
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-6 text-center">
              <p className="text-red-600 font-semibold">Error loading bulk orders: {error}</p>
